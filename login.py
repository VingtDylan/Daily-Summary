...
def login(username, password):
    ...
    url='http://172.16.1.28/PortalServer/Webauth/webAuthAction!login.action'
...
def sync(ipAddr, sessionID, XSRF_TOKEN):
    ...
    url = 'http://172.16.1.28/PortalServer/Webauth/webAuthAction!syncPortalAuthResult.action'
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ping_command = ('ping -W 1 -c 1 ', 'ping -w 1000 -c 1 ')['Windows' in platform.system()]
